...
const Home = () => {
  ...
  return (
    <div className="flex gap-0 w-screen flex-col lg:flex-row">
      <Sidebar />
      <div className="flex px-4 py-6 lg:px-20 lg:py-12 lg:w-[85%] flex-col gap-10">
        ...
        <div className="flex flex-col items-center justify-center w-full gap-8 lg:gap-16">
          <div className="flex flex-col gap-6 lg:gap-10 items-center">
            ...
            <div className="flex flex-col items-center justify-center gap-6 lg:gap-8">
              <div className="scale-[1.2] lg:scale-[1.3]">
                <Search />
              </div>
              ...
              <div className="flex gap-4 lg:gap-8 items-center">
                <div className="flex gap-2 lg:gap-4 items-center">
                  <div
                    ...
                    tabIndex={0}
                  >
                    <FaTh className={`text-white w-5 lg:w-6 ${!isListView && 'text-blue-500'}`} />
                  </div>
                  <div
                    className="flex items-center cursor-pointer justify-center w-12 h-12 lg:w-14 lg:h-14 rounded-[4px] bg-[#222222]"
                    ...
                    tabIndex={0}
                  >
                    <FaList className={`text-white w-5 lg:w-6 ${isListView && 'text-blue-500'}`} />
                  </div>
                </div>
