...
function RegisterFormView() {
    ...
    const { register, watch, formState: { errors }, handleSubmit: onSubmit } = useForm<Form>({
        defaultValues: {
            email: '',
            password: '',
            confirmPassword: '',
            ...
            <div className="flex flex-col items-start gap-3">
                <div className="flex flex-col w-full md:flex-row items-start gap-3">
                    <div className='flex justify-center gap-2 flex-col w-full'>
                        ...
                        />
                        {
                            errors.firstName && <p className="text-[#b73939] font-medium text-sm w-full text-left ml-4">{errors.firstName.message}</p>
                        }
                    </div>
                    <div className='flex justify-center gap-2 flex-col w-full'>
                        <Input
                        ...
                        />
                        {
                            errors.lastName && <p className="text-[#b73939] font-medium text-sm w-full text-left ml-4">{errors.lastName.message}</p>
                        }
                    </div>
                </div>
                <div className='flex justify-center gap-2 flex-col w-full'>
