...
function OAuthButton({ type, operation }: Props) {
  ...
  return (
    <button
      ...
      type="button"
      className="w-full px-8 py-5 text-xl transition-all hover:opacity-85 flex items-center gap-4 justify-center placeholder:text-[#989898] text-[16px] text-white bg-[#303030] rounded-full outline-none"
      disabled={loading}
    >
      {loading ? (
